...
namespace HandHmod.NPCs.NeoTheLesser
{
    ...
    public class Neo : ModNPC
    {
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem(npc.getRect(), ModContent.ItemType<NeoTrophy>());
            }
            if (Main.expertMode)
            {
                npc.DropBossBags();
            ...
            else
            {
                ...
                {
                    Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Weapons.Magic.NeoDarkCreationStaff>());
                }
                Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Misc.Materials.CursedSoulOfHell>(), 800);
                Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Misc.Materials.HeavenlySoul>(), 800);
                Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Weapons.Melee.NeoSpearWeapon>());
                Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Weapons.Melee.NeoBlade>());
                Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Weapons.Melee.NeoSickle>());
            }
        }
        ...
        public override void BossLoot(ref string name, ref int potionType)
        {
            ...
            if (!HandHmodWorld.downedNeo)
            {
                HandHmodWorld.downedNeo = true;
