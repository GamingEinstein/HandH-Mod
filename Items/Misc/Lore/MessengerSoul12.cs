...
namespace HandHmod.Items.Misc.Lore
{
    public class DevourerOfHellfire : ModItem
    {
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("This worm isn't like others. It looks of Hell, but has powers like that of another world, may god protect those brave enough to slay it...");
		}
