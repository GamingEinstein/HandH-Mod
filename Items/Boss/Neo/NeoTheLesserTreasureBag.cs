...
{
    public class NeoTheLesserTreasureBag : ModItem
    {
        public override int BossBagNPC => mod.NPCType("Neo");
        ...
        public override void OpenBossBag(Player player)
        {
            ...
            {
                player.QuickSpawnItem(ItemID.GoldCoin, 1000);
                ...
                {
                    player.QuickSpawnItem(ItemType<NeoDarkCreationStaff>());
                }
                if (Main.rand.NextBool(50))
                {
                    ...
                    if (Main.rand.Next(7) == 0)
                    {
                        player.QuickSpawnItem(ItemType<NeoSoul>());
                    }
                    if (Main.rand.Next(100) == 0)
                    {
                        player.QuickSpawnItem(ItemType<NeoTheLesserTreasureBag>());
                    }
                }
            }
        }
